import select, time, electrum_rubycoin as electrum, Queue
from electrum_rubycoin import Connection, Interface, SimpleConfig
from electrum_rubycoin.network import filter_protocol, parse_servers
...
def get_peers():
    ...
    server = 'electrum.rubycoinplatform.com:50002:s'
