...
from electrum_rubycoin.keystore import bip39_normalize_passphrase
from electrum_rubycoin.rubycoin import EncodeBase58Check
    ...
    def callback_PassphraseRequest(self, req):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the rubycoins in the wallet.") % self.device
        else:
...
class TrezorClientBase(GuiMixin, PrintError):
    ...
    #    return self.get_address('Rubycoin', self.expand_path(derivation))
