...
try:
    import electrum
    from electrum_stratis.bitcoin import TYPE_ADDRESS, var_int, msg_magic, Hash, verify_message, public_key_to_p2pkh, EncodeAES, DecodeAES
    from electrum_stratis.i18n import _
    from electrum_stratis.keystore import Hardware_KeyStore
    from ..hw_wallet import HW_PluginBase
    from electrum_stratis.util import print_error
