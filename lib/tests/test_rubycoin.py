...
class Test_rubycoin(unittest.TestCase):
    ...
    def test_xpub_from_xprv(self):
        ...
        # Taken from test vectors in https://en.rubycoin.it/wiki/BIP_0032_TestVectors
...
class Test_keyImport(unittest.TestCase):
    """ The keys used in this class are TEST keys from
        https://en.rubycoin.it/wiki/BIP_0032_TestVectors"""
