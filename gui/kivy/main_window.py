...
from electrum_rubycoin.rubycoin import TYPE_ADDRESS
from electrum_rubycoin import WalletStorage, Wallet
from electrum_rubycoin_gui.kivy.i18n import _
from electrum_rubycoin.contacts import Contacts
from electrum_rubycoin.paymentrequest import InvoiceStore
from electrum_rubycoin.util import profiler, InvalidPassword
from electrum_rubycoin.plugins import run_hook
from electrum_rubycoin.util import format_satoshis, format_satoshis_plain
...
Factory.register('InstallWizard',
                 module='electrum_rubycoin_gui.kivy.uix.dialogs.installwizard')
Factory.register('InfoBubble', module='electrum_rubycoin_gui.kivy.uix.dialogs')
Factory.register('OutputList', module='electrum_rubycoin_gui.kivy.uix.dialogs')
Factory.register('OutputItem', module='electrum_rubycoin_gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_rubycoin_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_rubycoin_gui.kivy.uix.screens')
...
class ElectrumWindow(App):
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'RBY')
    ...
    def on_qr(self, data):
        from electrum_rubycoin.rubycoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrum_rubycoin.transaction import Transaction
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_rubycoin.util import format_time
    ...
    def on_start(self):
        ...
        # bind intent for rubycoin: URI scheme
        if platform == 'android':
            from android import activity
            from jnius import autoclass
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_rubycoin_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_rubycoin_gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_rubycoin_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_rubycoin_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/electrum-rubycoin.png"
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-Rubycoin', message,
                            app_icon=icon, app_name='Electrum-Rubycoin')
        except ImportError:
