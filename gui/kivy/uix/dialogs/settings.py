...
from electrum_rubycoin.rubycoin import RECOMMENDED_FEE
from electrum_rubycoin import coinchooser

from choice_dialog import ChoiceDialog

Builder.load_string('''
#:import partial functools.partial
#:import _ electrum_rubycoin_gui.kivy.i18n._
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Rubycoin amounts.")
                    action: partial(root.unit_dialog, self)
                CardSeparator
                SettingsItem:
                    status: root.fee_status()
                    title: _('Fees') + ': ' + self.status
                    description: _("Fees paid to the Rubycoin miners.")
...
class SettingsDialog(Factory.Popup):
    ...
    def fee_status(self):
        if self.config.get('dynamic_fees', True):
            from electrum_rubycoin.util import fee_levels
