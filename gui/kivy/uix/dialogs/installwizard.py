...
from electrum_rubycoin_gui.kivy.uix.dialogs import EventsDialog
from electrum_rubycoin_gui.kivy.i18n import _
from electrum_rubycoin.base_wizard import BaseWizard
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_rubycoin.old_mnemonic import words as old_wordlist
