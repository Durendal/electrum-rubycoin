...
title = Electrum-Rubycoin

# (str) Package name
package.name = Electrum-Rubycoin

# (str) Package domain (needed for android/ios packaging)
package.domain = org.electrum_rubycoin
...
presplash.filename = %(source.dir)s/icons/electrum-rubycoin.png
...
android.manifest.intent_filters = gui/kivy/tools/rubycoin_intent.xml
