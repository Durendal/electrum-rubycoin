...
from electrum_rubycoin.util import format_satoshis, set_verbosity
from electrum_rubycoin.util import StoreDict
from electrum_rubycoin.rubycoin import is_valid, COIN, TYPE_ADDRESS
from electrum_rubycoin import Wallet, WalletStorage
...
class ElectrumGui:
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            self.show_message(_('Invalid Rubycoin address'))
            return
        try:
