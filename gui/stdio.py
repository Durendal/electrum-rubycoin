...
_ = lambda x:x
#from i18n import _
from electrum_rubycoin.wallet import WalletStorage, Wallet
from electrum_rubycoin.util import format_satoshis, set_verbosity, StoreDict
from electrum_rubycoin.rubycoin import is_valid, COIN, TYPE_ADDRESS
from electrum_rubycoin.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-rubycoin create'"
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-rubycoin setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-rubycoin setconfig' to change your settings")
        return True
